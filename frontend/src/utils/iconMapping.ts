...
export const getFoodIcon = (type: string, category: string): string => {
  ...
  const typeIcons: Record<string, string> = {
    ...
    // Additional types
    'snack': 'icon-park-outline:dot',
    'fruit': 'mdi:food-apple',
    'sub': 'game-icons:sandwich',
    'sandwich': 'mdi:food-hot-dog',
    'wrap': 'mdi:food-hot-dog',
    'soup': 'icon-park-outline:dot',
    'curry': 'icon-park-outline:dot',
    'kebab': 'icon-park-outline:dot',
    'hotdog': 'mdi:food-hot-dog',
    'panini': 'mdi:food-hot-dog',
    'quesadilla': 'icon-park-outline:dot',
    'burrito': 'icon-park-outline:dot',
    'enchilada': 'icon-park-outline:dot',
    'fajita': 'icon-park-outline:dot',
    'gyro': 'icon-park-outline:dot',
    'shawarma': 'icon-park-outline:dot',
    'falafel': 'icon-park-outline:dot',
    'dumpling': 'icon-park-outline:dot',
    'springroll': 'icon-park-outline:dot',
    'eggroll': 'icon-park-outline:dot',
    'tempura': 'icon-park-outline:dot',
    'teriyaki': 'icon-park-outline:dot',
    'stirfry': 'icon-park-outline:dot',
    'lo mein': 'icon-park-outline:dot',
    'pad thai': 'icon-park-outline:dot',
    'pho': 'icon-park-outline:dot',
    'ramen': 'icon-park-outline:dot',
    'udon': 'icon-park-outline:dot',
    'soba': 'icon-park-outline:dot',
    'bibimbap': 'icon-park-outline:dot',
    'bulgogi': 'icon-park-outline:dot',
    'japchae': 'icon-park-outline:dot',
    'kimchi': 'icon-park-outline:dot',
    'taco': 'icon-park-outline:dot',
    'thai': 'icon-park-outline:dot',
    'noodlesoup': 'icon-park-outline:dot',
    'noodles': 'icon-park-outline:dot',
    'pasta': 'icon-park-outline:dot',
    'sushi': 'icon-park-outline:dot',
